...
<head>
    ...
    <title>Create New Password - Attendance System</title>
...
<body>
    ...
    <div class="auth-container">
        <div class="logo-section">
            ...
            <p class="subtitle">Set up a new password for your account</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username">
            </div>
