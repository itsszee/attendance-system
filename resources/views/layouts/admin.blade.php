...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-link">
            <i class="fas fa-clipboard-check brand-image"></i>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.qr.index') }}" class="nav-link {{ request()->routeIs('admin.qr.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('location_settings.index') }}" class="nav-link {{ request()->routeIs('location_settings.*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-map-marker-alt"></i>
                            <p>Lokasi QR Radius</p>
                        </a>
                    </li>
